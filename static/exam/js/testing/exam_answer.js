  ...
  $(".fontsize-btn-r").click(function(e){
    ...
    */
     ...
     $('.keyCloze').each(function () {
         ...
         var questionsId = parentDiv.attr('questionsId');
         editor.config.uploadImgUrl = "/upload/?role=staff&action=uploadimage&exam_info_id="+exam_info_id+"&exam_results_id="+exam_results_id+"&question_id="+ questionsId;
...
function saveAnswerFn(questionsId,keyList){
	var dataForm = "exam_results_id="+exam_results_id+"&exam_info_id="+exam_info_id+"&test_id="+questionsId+"&test_ans="+encodeURIComponent(keyList);
	$.ajax({
		type: "POST",
		dataType: "json",
